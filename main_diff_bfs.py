...
if __name__ == "__main__":
    ...
    data_set = bfs_dataset(
        data_location=seq_args.data_location,
        trajec_max_len=diff_args.Nt,  # seq_args.trajec_max_len,
        start_n=seq_args.start_n,
        n_span=seq_args.n_span,
    )
    data_loader = DataLoader(
        dataset=data_set, shuffle=diff_args.shuffle, batch_size=diff_args.batch_size
    )
    ...
    train_diff(
        diff_args=diff_args, seq_args=seq_args, trainer=trainer, data_loader=data_loader
    )
