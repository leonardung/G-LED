...
class Args:
    def __init__(self):
        ...
        """
        self.parser.add_argument(
            "--n_layer", default=8, help="number of attention layer"  # 8
        )
        self.parser.add_argument(
            "--output_hidden_states", default=True, help="out put hidden matrix"
        )
        self.parser.add_argument(
            "--output_attentions", default=True, help="out put attention matrix"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--layer_norm_epsilon", default=1e-5, help="############ Do not change"
        )
        self.parser.add_argument("--attn_pdrop", default=0.0, help="T.B.D")
        self.parser.add_argument("--resid_pdrop", default=0.0, help="T.B.D")
        self.parser.add_argument(
            "--activation_function", default="relu", help="Trust OpenAI and Nick"
        )
        self.parser.add_argument(
            "--initializer_range", default=0.02, help="Trust OpenAI and Nick"
        )
        ...
        """
        self.parser.add_argument(
            "--start_Nt", default=1, help="The starting length of forward propgatate"
        )
        self.parser.add_argument(
            "--d_Nt", default=1, help="The change length of forward propgatate"
        )
        self.parser.add_argument(
            "--batch_size",
        ...
        self.parser.add_argument(
            "--march_tol", default=0.01, help="march threshold for Nt + 1"
        )
